...
public final class MybatisPlusCodeGenerator {
  ...
  private static final String DB_URL =
      "jdbc:mysql://localhost:3306/espdb?serverTimezone=Asia/Shanghai&characterEncoding=utf8&useUnicode=true&useSSL=false&allowPublicKeyRetrieval=true";
